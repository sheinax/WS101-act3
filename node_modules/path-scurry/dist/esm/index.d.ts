...
export interface WalkOptions {
     ...
     * to do that.
     *
     * Asynchronous func filtratzen bada, alerta bat jasoko duzuZure pasahitzak bakarrak diraZure pasahitzak asmatzeko zailak diruditePasahitz seguruak erabiltzen dituzuBerrezarri da pasahitzaNorbaitek pasahitz berrerabili bat aurkitzen badu, beste kontuetan sartzeko erabil dezake.pasahitz bera duten kontuak: $1Erabili pasahitz bakarrak gune edo aplikazio bakoitzerakoAbian da aztertze-eragiketa ($1 / $2)Gaitu filtratutako pasahitza aztertzeko aukera hemen: $1Filtratutako $1 pasahitz$1 / $2 pasahitz aztertu dira$1 honetarako aurkitutako guneak eta aplikazioak: $2Segurtasun-argibideakikusi xehetasunakHautatu kategoria$1 kontuakIkusi filtrazioaren xehetasunakPasahitz ahulak errazago asmatzen dira. Mantendu zure kontuak seguruago pasahitz seguruago batekin.Sortu pasahitz seguruagoakBerreskuratu da ezabatutako helbidea.Informazio pertsonalaren ezarpenakTxartelakErreserbaren IDaSarreraIrteeraAktibatu sinkronizazioa bidaia- eta gertaera-txarteletarako zerbitzu integrala izateko.Ez duzu aktibatu Bing-en datuen sinkronizazioa.Hasi saioa zure sarrerak Diru-zorroarekin sinkronizatzeko.Ez dago txartelik oraindikZure txartelak Bing Travel-etik diru-zorro honekin sinkronizatuko dira.Iraungitako sarrerakKudeatu erreserbaHornitzailea: $1Kendu egin da tiketaSarrera hau diru-zorrotik kendu nahi duzu?Erreserbaren xehetasunakZure bidaia-datu guztietarako sarbide errazaBistaratu Bing-eko bidaia-erreserbaren datuakErreserbatutaBertan behera utzi du erabiltzaileakBertan behera utzi du saltzaileakOsatutaIkusi $1 iraungitako sarrerakIkusi iraungitako sarrera batJoan webgune ofizialeraEz dut nahi nire kidetzak diru-zorroan agertzeaDiru-zorroan kidetza mota gehiago gorde nahi ditutEz dut nahi nire txartelak diru-zorroan agertzeaDiru-zorroan txartel gehiago gorde nahi ditutZure opari batek eragin handia izan dezake. Bidali opari bat zure funtsekin edo irabazi dituzun Rewards puntuekin. Dohaintza egiten duzunean, zure posta elektronikoan jasoko duzu dohaintzaren emaitza. $1 Eskerrik asko $2-ri dohaintza bat egiteagatik./hileanDohaintza bat egitean, onartzen dituzu gure $1
       eta onartzen duzu zure izena, helbidea eta dohaintzaren zenbatekoa Benevity-rekin eta AOGFrekin partekatuko direla, gure $2
      , eta Benevity-ren $3
       eta $4
       jarraikiz eta haien mende. $5
      .$6 Microsoft-ek ez ditu babesten irabazi asmorik gabeko erakundeak. Microsoft eta Benevity bazkideak dira dohaintzak gauzatzeko. American Online Giving Foundation (AOGF) delakoan dagoen eta emaileek gomendatu duten funts batean egiten duzu dohaintza, $7
       erakundeari emateko gomendioarekin. Onartzen duzu AOGFk duela zure dohaintzaren legezko kontrol esklusiboa. Dohaintzak ez dira itzulgarriak.Microsoft-ek ez ditu babesten irabazi asmorik gabeko erakundeak. Micros